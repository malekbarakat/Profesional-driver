...
let questions = [
  {
    numb: 1,
    question: "من الحالات التي لا یجوز للسائق الدوران بالاتجاه المعاكس",
    answer: "جمیع ما ذكر",
    options: [
      "اذا كان الدوران یعیق حركة السیر او یعرض مستخدمي الطریق للخطر",
      "في مكان یتعذر مشاھدة مركبته من قبل سائق مركبة اخرى",
      "اذا كان الدوران بالقرب من منعطف او قمة منحدرة",
      "جمیع ما ذكر",
    ],
  },
